...
roundypi.send('["device/mcp23X17", {"config": {"device": {"type": "button", "name": "control", "inputs": [{"pin": "A2", "label": "sigX"}], "actions": {}}}}]')
roundypi.send('["device/mcp23X17", {"config": {"device": {"type": "toggle", "name": "volume",  "inputs": [{"pin": "A7", "label": "sigX"}], "actions": {"true": "on", "false": "off"}}}}]')
roundypi.send('["device/mcp23X17", {"config": {"device": {"type": "switch", "name": "motion",  "inputs": [{"pin": "B1", "label": "sigX"}], "actions": {}}}}]')
