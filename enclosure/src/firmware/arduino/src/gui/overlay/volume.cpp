...
//TODO			util_jpeg_decode565_littlefs(LITTLEFS_BASEPATH "images/overlay/volume/speaker.jpg", g_gui_overlay_icon, GUI_OVERLAY_ICON_WIDTH*GUI_OVERLAY_ICON_HEIGHT);
...
//TODO			util_jpeg_decode565_littlefs(LITTLEFS_BASEPATH "images/overlay/volume/speaker-mute.jpg", g_gui_overlay_icon, GUI_OVERLAY_ICON_WIDTH*GUI_OVERLAY_ICON_HEIGHT);
//TODO			for(int y=0; y<GUI_OVERLAY_ICON_HEIGHT; y++) {
//TODO				for(int x=0; x<GUI_OVERLAY_ICON_WIDTH; x++) {
//TODO					if(g_gui_overlay_icon[y*GUI_OVERLAY_ICON_WIDTH+x] != TFT_BLACK) {
