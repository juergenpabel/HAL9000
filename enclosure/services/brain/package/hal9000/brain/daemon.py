		...
		try:
			async for message in mqtt.messages:
				...
				match topic:
					...
					case other:
						if (self.plugins['brain'].runlevel in [HAL9000_Plugin.RUNLEVEL_STARTING, HAL9000_Plugin.RUNLEVEL_READY]) or \
						   (self.plugins['brain'].runlevel == HAL9000_Plugin.RUNLEVEL_RUNNING and \
						    self.plugins['brain'].status == Daemon.BRAIN_STATUS_AWAKE):
							signals = {}
