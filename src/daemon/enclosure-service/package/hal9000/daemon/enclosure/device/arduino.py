...
from hal9000.daemon.enclosure.device import HAL9000_Device
from hal9000.daemon.enclosure.driver import HAL9000_Driver
...
class Device(HAL9000_Device):
	...
	def mqtt_publish_status(self, status):
		if Device.status != status:
			...
			mqtt_topic = 'hal9000/daemon/enclosure-service/event/webserial:state'
			mqtt_payload = status
	...
	def mqtt_publish_screen(self, screen):
		mqtt_topic = 'hal9000/daemon/enclosure-service/event/gui:screen'
	...
	def mqtt_publish_error(self, error):
		mqtt_topic = 'hal9000/daemon/enclosure-service/event/application:error'
